...
import backWardImg from '../../images/carbon_drill-back.png'
import css from "./customModal.module.css";


const CustomDashboardModal = ({ showModal, closeModal, location, user }) => {
	...
	return (
		<Modal show={showModal} onHide={closeModal} className={css.cardWidth}>
			<Modal.Body >
				<div className='d-flex justify-content-center'>
					<img src={backWardImg} alt="backWardImg" onClick={closeModal} />
				</div>
				<div className=" m-2 ">
					<Link to={"/dashboard"}>
